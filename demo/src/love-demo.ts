...
// Love2D-style update callback - called every frame
...
love.draw = (_canvas) => {
  ...
  // Draw title
  graphics.print('white', 'Love2D-style API Demo', [20, 30], { 
...
// Love2D-style keypressed callback
love.keypressed = (scancode: string, keycode: string) => {
  console.log(`Key pressed: ${keycode} (scancode: ${scancode})`);
};

// Love2D-style keyreleased callback
love.keyreleased = (scancode: string, keycode: string) => {
  console.log(`Key released: ${keycode} (scancode: ${scancode})`);
};

// Love2D-style mousepressed callback
love.mousepressed = (x: number, y: number, button: number) => {
  console.log(`Mouse pressed at ${x}, ${y}, button: ${button}`);
};

// Love2D-style mousereleased callback
love.mousereleased = (x: number, y: number, button: number) => {
  console.log(`Mouse released at ${x}, ${y}, button: ${button}`);
};

// Love2D-style gamepadpressed callback
love.gamepadpressed = (gamepadIndex: number, buttonIndex: number, buttonName: string) => {
  console.log(`Gamepad ${gamepadIndex}: ${buttonName} (button ${buttonIndex}) pressed`);
};

// Love2D-style gamepadreleased callback
love.gamepadreleased = (gamepadIndex: number, buttonIndex: number, buttonName: string) => {
