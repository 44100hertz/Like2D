 ...
 *
 * ```typescript
 * import { createLike, StartupScene } from 'like2d';
 * import { GameScene } from './game';
 *
 * const game = createLike(container);
 *
 * // Start with the startup scene, transition to game on click
 * game.setScene(new StartupScene(new GameScene()));
 * game.start();
 * ```
 *
 * ## Custom Rendering
